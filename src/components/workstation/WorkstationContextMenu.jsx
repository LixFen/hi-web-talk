      ...
      case "group":
        return (
          <>
            ...
            <button className="context-menu-item" onClick={() => { onToggleViewMode?.(); onClose(); }}>
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        return (
          <>
            {isDeleted ? (
              ...
              <>
                <button className="context-menu-item" onClick={() => { onStartConnection?.(sessionHash, groupId); onClose(); }}>
                  <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2">
